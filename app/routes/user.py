...
## NOTE: Recommendation and duplicate stats endpoints removed.
## The comprehensive recommendations endpoint now lives in `recommendation.py`.
## This removal resolves duplicate OpenAPI operation IDs and path conflicts.
